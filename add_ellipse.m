function out_image_matrix = add_ellipse(src_image_matrix,y0, x0, a, b, teta, color)
...
% Version:   1.1
% Author:    Nicolae Cindea (modified by Jonas Traub)
% Source:    http://www.mathworks.com/matlabcentral/fileexchange/17499-drawing-an-ellipse-into-a-matrix-image/content/ellipseMatrix.m

im = zeros(size(src_image_matrix));
[ny, nx] = size(im);
imtemp = zeros(ny, nx);
list = zeros(ny * nx, 2);
toplist = 1;
...
out_image_matrix = im+src_image_matrix;
